package com.internshalaP.javaFXapp;
...
public class Controller implements Initializable {
	...
	public static final String discColour1 = "#24303E";
	public static final String discColour2 = "#4CAA88";
	...
	public void setNames() {
		...
		playerNameLabel.setText(player1Name.getText());
	}
	...
	private  void insertDisc(Disc disc,int column){
		...
		translateTransition.setOnFinished(event -> {
			...
			playerNameLabel.setText(isPlayerOneTurn?player1Name.getText(): player2Name.getText());
		});
	...
	private void gameOver() {
		String winner = isPlayerOneTurn ? player1Name.getText(): player2Name.getText();
